public class Principal {
    ...
    public static void main( String[] args ) {
        ...
        livro.registra( new OrdemLimitada( cliente, numCorretora,
                LivroDeOfertas.Direcao.VENDA, 1000, 14.97 ) );
        livro.registra( new OrdemLimitada( cliente, numCorretora,
                LivroDeOfertas.Direcao.VENDA, 1000, 15.97 ) );
        
        
        livro.registra( new OrdemLimitada( cliente, numCorretora,
                LivroDeOfertas.Direcao.COMPRA, 1500, 14.97 ) );
        livro.registra( new OrdemLimitada( cliente, numCorretora,
                LivroDeOfertas.Direcao.COMPRA, 1500, 15.97 ) );
        /*livro.registra( new OrdemLimitada( cliente, numCorretora,
                LivroDeOfertas.Direcao.VENDA, 500, 15.97 ) );*/
